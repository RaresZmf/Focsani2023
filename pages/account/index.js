    ...
    return(
        <div className='text-black'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                />
                <button onClick={userLogOut} className="w-[150px] h-[35px] my-[5px] sm:my-[20px] bg-lime-500 text-white border-[2px] border-lime-500 rounded-3xl" round>Logout</button>
            </div>
