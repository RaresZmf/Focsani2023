...
export default function Editor({ read, title, json, note, user, actual_user, owner }) {
    ...
    return (
        <div className="flex flex-col items-center content-center justify-center mt-[20vh]">
            <input disabled={loading} onChange={(e) => settitlu(e.target.value)} className='text-gray-700 bg-transparent self-start w-full caret-blue-500 border-transparent focus:border-transparent focus:ring-0 text-5xl focus:outline-none' placeholder='Titlu' />
            ...
            <div className="flex flex-row justify-center items-start space-x-10 pt-4">
                <div className="text-3xl text-center font-bold group text-black relative">
                    <button className="text-black bg-white">{utilizare.charAt(0).toUpperCase() + utilizare.slice(1)}</button>
                ...
                <div className="text-3xl text-center font-bold group text-black relative">
                    <button className="text-black bg-white">{dificultate.charAt(0).toUpperCase() + dificultate.slice(1)}</button>
                    <div className="invisible group-hover:visible relative flex flex-col left-[0px] top-4 pb-6 space-y-2">
